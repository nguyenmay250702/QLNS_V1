...
<div class="container-full mt-2">
        <div class="card mb-5 title">
            ...
            <div style="padding: 10px">
                Danh sách phòng ban/Sửa thông tin phòng ban
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <span style="font-weight: 600;">Sửa thông tin phòng ban</span>
                    ...
                    <div class="d-lg-flex justify-content-between">
                        <div class="mb-3 w-100" style="align-items: center;">
                            ...
                            <div class="mx-5 my-3">
                                ...
                                <div class="">
                                    <input type="text" name="txt_address" class="form-control @error('address') is-invalid @enderror" value="{{ $department->address }}" />
                                    @error('address')
                                        <div style="color: red;font-style: italic">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mx-5 my-4">
                                ...
                                <div class="d-flex justify-content-evenly p-2">
                                    <div class="form-check m-0" style="width: 100px">
                                        <input class="form-check-input" type="radio" name="txt_status" id="flexRadioDefault2" value="1" @if($department->status ==1) checked @endif>
                                        <label class="form-check-label" for="flexRadioDefault2">hoạt động</label>
                                    </div>
                                    <div class="form-check m-0" style="width: 100px">
                                        <input class="form-check-input" type="radio" name="txt_status" id="flexRadioDefault1" value="0" @if($department->status ==0) checked @endif>
                                        <label class="form-check-label" for="flexRadioDefault1">dừng</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 15px;color: black">
                ...
                <div>Bạn có chắc chắn muốn thoát khỏi chức năng sửa thông tin phòng ban không?</div>
            </div>
            <div class="modal-footer" style="justify-content: center; display: flex;">
                <a href="{{ route('departments.search') }}" class="btn btn-luu">có</a>
