...
<div class="container-full mt-2">
        <div class="card mb-5 title">
            ...
            <div style="padding: 10px">
                Danh sách tài khoản/Tạo mới phòng ban
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <span style="font-weight: 600;">Tạo mới phòng ban</span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 15px;color: black">
                ...
                <div>Bạn có chắc chắn muốn thoát khỏi chức năng tạo mới phòng ban không?</div>
            </div>
