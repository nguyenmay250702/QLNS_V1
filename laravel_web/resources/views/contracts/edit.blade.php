                    ...
                    <div class="d-lg-flex justify-content-between">
                        <div class="mb-3 w-100" style="align-items: center;">
                            ...
                            <div class="mx-5 my-4">
                                ...
                                <div class="">
                                    <input type="text" name="txt_phone_number" class="form-control @error('phone_number') is-invalid @enderror" value="{{ $staff->phone_number }}" oninput="validateInput_int(this, 9999999999)"/>
                                    @error('phone_number')
                                        <div style="color: red;font-style: italic">{{ $message }}</div>
                                    @enderror
                                </div>
