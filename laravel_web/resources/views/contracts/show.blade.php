            ...
            <div class="card-body p-5" style="margin: 3% 20%; border: 1px solid #d7d7d7;">
                <div class="d-flex justify-content-between mb-5">
                    ...
                    <div>
                        ...
                        <div class="py-1"><span class="d-inline-block" style="width: 100px">Họ tên: </span> <span>{{$staff->name}}</span></div>
                        <div class="py-1"><span class="d-inline-block" style="width: 100px">Ngày sinh: </span> <span>{{$staff->birthday}}</span></div>
                        <div class="py-1"><span class="d-inline-block" style="width: 100px">Số điện thoại: </span> <span>{{$staff->phone_number}}</span></div>
                        <div class="py-1"><span class="d-inline-block" style="width: 100px">Địa chỉ: </span> <span>{{$staff->address}}</span></div>
                        <div class="py-1"><span class="d-inline-block" style="width: 100px">Giới tính: </span> <span> @if($staff->gender==1) nữ @else nam @endif </span></div>
                    </div>
                </div>
                <div>
