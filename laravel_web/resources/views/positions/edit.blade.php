...
<div class="container-full mt-2">
        <div class="card mb-5 title">
            ...
            <div style="padding: 10px">
                Danh sách phòng ban/Sửa thông tin vị trí công việc
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <span style="font-weight: 600;">Sửa thông tin vị trí công việc</span>
                            ...
                            <div class="mx-5 my-4">
                                ...
                                <div class="d-flex justify-content-evenly p-2">
                                    <div class="form-check m-0" style="width: 100px">
                                        <input class="form-check-input" type="radio" name="txt_status" id="flexRadioDefault2" value="1" @if($position->status ==1) checked @endif>
                                        <label class="form-check-label" for="flexRadioDefault2">hoạt động</label>
                                    </div>
                                    <div class="form-check m-0" style="width: 100px">
                                        <input class="form-check-input" type="radio" name="txt_status" id="flexRadioDefault1" value="0" @if($position->status ==0) checked @endif>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="font-size: 15px;color: black">
                ...
                <div>Bạn có chắc chắn muốn thoát khỏi chức năng sửa thông tin vị trí công việc không?</div>
            </div>
