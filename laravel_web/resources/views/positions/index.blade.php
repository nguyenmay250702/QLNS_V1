...
@section('content')
    ...
    <div class="container-full mt-2">
        <div class="card mb-5 title">
         ...
         <div class="card">
            <div class="card-body">
                <span style="font-weight: 600;">Tìm kiếm vị trí công việc</span>
                <div style="border-top: 2px solid #f87729; margin-top: 5px;"></div>
            </div>

            <div class="card-body">
                <form method="get" action="{{ route('positions.search') }}" id="form_search">
                    {{-- @csrf --}}
                    <input name='function' type="text" hidden value="search">
                    <div class="d-lg-flex justify-content-between">
                        <div class="mb-3 w-100" style="align-items: center;">
                            <div class="mx-5 my-4">
                                <label class="col-label-form">Tên vị trí công viêc:</label>
                                <div class="">
                    ...
                    <div class="text-center">
                        ...
                        <a type="button" href="{{route("positions.search")}}" class="btn btn-huy m-2">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card mt-4">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    <a href="{{ route('positions.create') }}" class="btn btn-mau btn-sm" style="width: 130px;">+ Tạo mới</a>
                            ...
                            <tr>
                                ...
                                <td class="position-relative" style="text-align: center; width: 20px">
                                    ...
                                    <div id="list_action{{$stt}}" class="action d-none position-absolute bg-secondary-subtle ">
                                        <a href="{{ route('positions.edit', $row['id']) }}" class="action_item px-3 py-2"><i class="fa-solid fa-pen-to-square" style="margin-right: 11px;"></i>sửa</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_delete" method="post" action="">
                        @csrf
                        @method('DELETE')
                        <div>Bạn có chắc chắn muốn xóa vị trí công việc không?</div>
...
@section('footer')
    <script>
        ...
        xoaModal.addEventListener('show.bs.modal', function(event) {
            ...
            form.action = "{{ route('positions.destroy', 'RECIPIENT') }}".replace('RECIPIENT', recipient);
        });
    </script>
